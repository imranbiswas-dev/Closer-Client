  ...
  return (
    <div>
      ...
      <div
        ...
        className="hs-overlay [--auto-close:lg] lg:block lg:translate-x-0 lg:inset-e-auto lg:bottom-0 w-64 hs-overlay-open:translate-x-0 -translate-x-full transition-all duration-300 transform h-full hidden fixed top-0 inset-s-0 bottom-0 z-60 bg-white dark:bg-neutral-800 border-e border-gray-200 dark:border-neutral-700"
        role="dialog"
        tabIndex="-1"
        aria-label="Sidebar"
      >
        <div className="relative flex flex-col h-full max-h-full">
          ...
          <header className="p-4 flex justify-between items-center gap-x-2">
            ...
            <div className="@@white.header.minifyToggle.class dark:@@neutral-800.header.minifyToggle.class">
              {/* Toggle Button */}
              <button
                type="button"
                className="flex justify-center items-center flex-none gap-x-3 size-9 text-sm text-gray-600 dark:text-neutral-300 hover:bg-gray-100 dark:hover:bg-neutral-700 rounded-full disabled:opacity-50 disabled:pointer-events-none focus:outline-hidden focus:bg-gray-100 dark:focus:bg-neutral-700"
                aria-haspopup="dialog"
                aria-expanded="false"
                aria-controls="hs-sidebar-header"
          ...
          <div className="mt-auto p-2 border-y border-gray-200 dark:border-neutral-700">
            ...
            <div className="hs-dropdown [--strategy:absolute] [--auto-close:inside] relative w-full inline-flex">
              ...
              >
                <div className="p-1">
                  <a
                    className="flex items-center gap-x-3 py-2 px-3 rounded-lg text-sm text-gray-800 dark:text-neutral-200 hover:bg-gray-100 dark:hover:bg-neutral-800 focus:outline-hidden focus:bg-gray-100 dark:focus:bg-neutral-800"
                    href="#"
                  >
                    My account
                  </a>
          ...
          {/* Body */}
          <nav className="h-full overflow-y-auto [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-none [&::-webkit-scrollbar-track]:bg-gray-100 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500">
            <div
            ...
            >
              <ul className="space-y-1">
                <li>
                  <a
                    className="flex items-center gap-x-3.5 py-2 px-2.5 bg-gray-100 dark:bg-neutral-700 text-sm text-gray-800 dark:text-neutral-200 rounded-lg hover:bg-gray-100 dark:hover:bg-neutral-700 focus:outline-hidden focus:bg-gray-100 dark:focus:bg-neutral-700"
                    href="#"
                  >
                    <svg
                      className="size-4"
                ...
                <li className="hs-accordion" id="users-accordion">
                  <button
                    type="button"
                    className="hs-accordion-toggle w-full text-start flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-gray-800 dark:text-neutral-200 rounded-lg hover:bg-gray-100 dark:hover:bg-neutral-700 focus:outline-hidden focus:bg-gray-100 dark:focus:bg-neutral-700"
                    aria-expanded="true"
                      ...
                      <li className="hs-accordion" id="users-accordion-sub-1">
                        ...
                        >
                          <ul className="pt-1 ps-2 space-y-1">
                            <li>
                              <a
                                className="flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-gray-800 dark:text-neutral-200 rounded-lg hover:bg-gray-100 dark:hover:bg-neutral-700 focus:outline-hidden focus:bg-gray-100 dark:focus:bg-neutral-700"
                                href="#"
                              >
                                Link 1
                              </a>
                ...
                <li>
                  <a
                    className="w-full flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-gray-800 dark:text-neutral-200 rounded-lg hover:bg-gray-100 dark:hover:bg-neutral-700 focus:outline-hidden focus:bg-gray-100 dark:focus:bg-neutral-700"
                    href="#"
                  >
                    <svg
                      className="size-4"
                    ...
                    Calendar{" "}
                    <span className="ms-auto py-0.5 px-1.5 inline-flex items-center gap-x-1.5 text-xs bg-gray-200 dark:bg-neutral-600 text-gray-800 dark:text-neutral-200 rounded-full">
                      New
                    </span>
                  </a>
                </li>
